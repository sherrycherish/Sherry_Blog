...
def user(username):
    ...
    pagination = user.posts.order_by(Post.timestamp.desc()). \
        paginate(page, per_page=current_app.config['SHERRY_BLOG_PER_PAGE'], error_out=False)
    posts = pagination.items
...
def followers(username):
    ...
    pagination = user.followers.paginate(
        page, per_page=current_app.config['SHERRY_BLOG_FOLLOWERS_PER_PAGE'],
        error_out=False)
